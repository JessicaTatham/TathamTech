          ...
          <AnimateIn>
            <div className="grid gap-16 md:grid-cols-[1fr_2fr]">
              ...
              <div className="flex flex-wrap gap-3">
                {skills.map((skill) => (
                  <span key={skill} className="rounded-full border border-primary/10 px-5 py-2.5 text-sm text-foreground/60 transition-colors hover:border-accent hover:text-primary-dark">
                    {skill}
                  </span>
                ))}
              </div>
